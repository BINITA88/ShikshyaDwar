...
//           <label className="block mb-2 text-sm font-medium text-gray-600">Course Name</label>
//           <input
//             type="text"
//             name="product_name"
...
//         </div>
//         <div className="relative mb-6">
//           <label className="block mb-2 text-sm font-medium text-gray-600">Course Price</label>
//           <input
//             type="number"
//             name="product_price"
//             className="block w-full px-4 py-2 border rounded"
...
//         </div> */}
//         <div className="relative mb-6">
//           <label className="block mb-2 text-sm font-medium text-gray-600">Course Description</label>
//           <textarea
...
//         </div>
//         <div className="relative mb-6">
//           <label className="block mb-2 text-sm font-medium text-gray-600">Course Image</label>
...
const UpdateProduct = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccess(true);
      setError('');
      setTimeout(() => navigate('/admin/productlist'), 200);
    } catch (err) {
      setError('Failed to update product');
      console.log(err);
    }
  ...
  const showError = () =>
    error && (
      <div className="bg-red-100 text-red-800 p-4 rounded-lg shadow-md mb-4" role="alert">
        <strong className="font-bold text-sm mr-2">Error!</strong>
        <span className="block text-sm sm:inline">{error}</span>
      </div>
    );
  ...
  const showSuccess = () =>
    success && (
      <div className="bg-green-100 text-green-800 p-4 rounded-lg shadow-md mb-4" role="alert">
        <strong className="font-bold text-sm mr-2">Success!</strong>
        <span className="block text-sm sm:inline">Product updated successfully!</span>
      </div>
    );
  ...
  return (
    <div className="max-w-4xl mx-auto bg-white p-10 rounded-lg shadow-lg mt-10">
      {showError()}
      {showSuccess()}
      <h2 className="text-3xl font-bold text-center text-gray-800 mb-6">Update Course</h2>
      <form onSubmit={handleSubmit} className="space-y-6">
        <div>
          <label className="block mb-2 text-lg font-medium text-gray-700">Course Name</label>
          <input
            type="text"
            name="product_name"
        ...
        <div>
          <label className="block mb-2 text-lg font-medium text-gray-700">Course Price</label>
          <input
            type="number"
            name="product_price"
            className="block w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
        ...
        <div>
          <label className="block mb-2 text-lg font-medium text-gray-700">Course Description</label>
          <textarea
            name="product_description"
            className="block w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
            value={product.product_description}
        ...
        <div>
          <label className="block mb-2 text-lg font-medium text-gray-700">Course Image</label>
          {product.product_image && (
            <div className="mb-4">
              <img src={'https'} alt="pre_image" className="w-24 h-24 object-cover rounded-lg shadow-md" />
            </div>
          )}
          <input
            name="product_image"
        ...
        <button className="w-full px-4 py-3 text-lg font-semibold text-white bg-indigo-600 rounded-lg shadow-md hover:bg-indigo-700 transition duration-300">
          Update Course
        </button>
      </form>
    </div>
