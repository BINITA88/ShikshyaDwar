    ...
    <div className="mt-6 sm:mt-8 md:gap-6 lg:flex lg:items-start xl:gap-8">
      <div className="mx-auto w-full flex-none lg:max-w-2xl xl:max-w-4xl">
        <div className="space-y-6">
          {product.length ===0 ?
          // semicolon bhanda agadai ko true bhayako condition ma garne ani pachadiko false bahyako condition condition chai product ko length 0 
         <h2 className='text-center font-bold text-2xl text-blue-950'>
        ...
        <div className="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
          <Link to="#" className="shrink-0 md:order-1">
            <img
              ...
              src={`http://localhost:900/${data.image}`}
              alt={data.image}
            />
            <img
