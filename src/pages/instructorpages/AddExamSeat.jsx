...
const AddExamSeat = () => {
  ...
  const [seatsStatus, setSeatsStatus] = useState({ available: [], unavailable: [] });
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      await axios.post("/api/seat/create", seatData, config);
    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-4xl mx-auto px-4">
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-gray-600">Add new exam seats for mock tests</p>
        </div>
        ...
        >
          <div className="border-b border-gray-200 bg-gray-50 px-6 py-4">
            <h3 className="text-lg font-medium text-gray-900">Exam Seat Information</h3>
          </div>
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="space-y-2">
              <label className="block text-sm font-medium text-gray-700">Seat Status</label>
              <div className="flex items-center space-x-4">
                ...
                <div className="flex items-center">
                  <input
                    ...
                    className="h-5 w-5 text-indigo-600 border-gray-300 rounded"
                  />
                  <span className="ml-2 text-sm text-gray-700">Unbooked</span>
                </div>
              </div>
            </div>
          ...
          <div className="mt-4">
            {allSeats.length === 0 ? (
              ...
              <ul className="space-y-4">
                {allSeats.map((seat) => (
                  <li key={seat.seatNumber} className="flex justify-between items-center">
